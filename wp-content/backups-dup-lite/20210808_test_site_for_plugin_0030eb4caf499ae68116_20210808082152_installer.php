...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210808_test_site_for_plugin_0030eb4caf499ae68116_20210808082152_archive.zip';
	const ARCHIVE_SIZE		 = '48646662';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0030eb4-08082152';
    const SECONDARY_PACKAGE_HASH = '556086c-08082152';
	const VERSION			 = '1.4.2';
